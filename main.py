    """
    Topic Modeller 533fedx
    ======================
    Command-line assistant leveraging transformer models to label content efficiently.
    ...
    APP_NAME    = "Topic Modeller 533fedx"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Command-line assistant leveraging transformer models to label content efficiently.")
